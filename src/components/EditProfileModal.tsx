...
//           onClick={handleSubmit}
//           disabled={!canSubmit || updateProfile.isPending}
//           className={`w-full rounded-2xl py-3.5 sm:py-4 text-[16px] font-semibold text-white transition ${
//             canSubmit && !updateProfile.isPending
//               ? 'bg-purple-700 active:scale-[0.98]'
//               : 'bg-purple-300'
//           }`}
...
//     >
//       {updateProfile.isError && (
//         <div className="flex items-center gap-2 px-4 py-3 mb-4 text-red-600 bg-red-50 sm:mb-4 rounded-2xl">
//           <AlertCircle size={16} className="shrink-0" />
//           <p className="text-[13px]">
//             {updateProfile.error instanceof Error
//               ? updateProfile.error.message
...
//         <p className="mb-2 sm:mb-2.5 mt-1 text-[15px] font-medium text-gray-800">Gender</p>
...
//         {/* Extra bottom padding so last field isn't hidden by scrollbar */}
//         <div className="" />
//       </div>
//     </ModalSheet>
//   )
...
export default function EditProfileModal({ onClose }: EditProfileModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* 
        overflow-y-auto makes this area scroll.
      ...
      */}
      ...
      >
        ...
        {/* Spacer so the last field isn't hidden behind the scrollbar */}
        <div className="h-4" />
      </div>
    </ModalSheet>
  )
