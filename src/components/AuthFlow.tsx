...
export default function AuthFlow({
  ...
  // "Continue with Google" button). The button itself is a real
  // Google-rendered iframe (see SignInModal), so this just receives the
  // credential response directly — no One Tap / prompt() flow involved.
  ...
  switch (screen) {
    ...
    case "forgot":
      return (
        <ForgotPasswordModal
          ...
          onSendCodeSuccess={(fullPhone, sessionId) => {
    ...
    case "new-password":
      return (
        <CreateNewPassword
          sessionId={resetSessionId}
          onComplete={() => setScreen("reset-success")}
        />
      );
