...
//   // Tries a fast, low-accuracy lookup first (resolves in ~1-2s via
//   // wifi/IP on most devices), then falls back to a slower high-accuracy
//   // GPS lookup with a longer timeout only if that fails. Forcing
//   // enableHighAccuracy immediately with a single timeout window is what
//   // was causing "Request timed out" on desktop browsers and indoors.
//   const handleUseMyLocation = () => {
//     setIsGettingLocation(true)
//     setLocationError(null)
