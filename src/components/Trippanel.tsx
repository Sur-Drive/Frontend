...
//               <div
//                 key={h.id}
//                 className="flex items-center gap-3 px-3 py-3 bg-gray-50 rounded-xl"
//               >
//                 <HazardGlyph icon={h.icon} />
//                 <div className="flex-1 min-w-0">
//                   <div className="text-[15px] font-bold text-gray-900 truncate">
...
//         <button
//           onClick={onEndTrip}
//           className="w-full h-12 mt-3 font-bold text-white bg-red-500 rounded-full active:scale-[0.98] transition"
//         >
//           End Trip
//         </button>
//       </div>
...
// }) {
//   return (
//     <div className="flex flex-col items-center justify-center py-1.5 border border-gray-100 rounded-xl">
...
function NavigatingPanel({
  ...
  return (
    ...
    >
      ...
      <div className="p-2.5 bg-white shadow-lg rounded-2xl">
        ...
        <button
          onClick={onEndTrip}
          className="w-full h-10 mt-2.5 text-sm font-bold text-white bg-red-500 rounded-full active:scale-[0.98] transition"
        >
          End Trip
        </button>
      </div>
...
function Stat({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-1 border border-gray-100 rounded-xl">
