    ...
    <div className={`relative flex flex-col items-center ${className}`}>
      <div className="flex items-center gap-0.5">
        <button
          onClick={toggleMuted}
          aria-label={muted ? "Unmute voice guidance" : "Mute voice guidance"}
          className="flex items-center justify-center flex-shrink-0 text-white w-6 h-6 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-white/20"
        >
          {muted ? (
        ...
        {showSettings && (
          <button
            ...
            aria-label={settingsOpen ? "Hide voice settings" : "Voice settings"}
            aria-expanded={settingsOpen}
            className="relative flex items-center justify-center flex-shrink-0 text-white w-5 h-6 sm:w-8 sm:h-9 rounded-lg sm:rounded-xl"
          >
