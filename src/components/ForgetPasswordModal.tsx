...
//   onSendCodeSuccess: (identifier: string, sessionId: string) => void;
// }
...
//     try {
//       const data = await forgotPassword.mutateAsync({ identifier });
//       const sessionId = data?.sessionId;
//       if (!sessionId) {
//         console.error(
//           "No sessionId received in forgot-password response:",
//           data,
//         );
//         setLocalError("Something went wrong. Please try again.");
//         return;
//       }
//       onSendCodeSuccess(identifier, sessionId);
//     } catch (err: any) {
...
//         setLocalError(
//           "Invalid phone number format. Please use a valid Nigerian number.",
//         );
...
//       ) {
//         setLocalError(
//           "Unable to send reset code. Please try again later or contact support.",
//         );
//       } else {
...
//               }}
//             >
//               Don&apos;t worry! It happens. Please enter your phone number or
//               email, and we&apos;ll send you a verification code to reset your
//               password. 🔒
//             </motion.p>
//           </div>
...
//                   }`}
//                   whileTap={
//                     isValid && !forgotPassword.isPending ? { scale: 0.97 } : {}
//                   }
//                   initial={{ opacity: 0, y: 30 }}
//                   animate={{ opacity: 1, y: 0 }}
//                   transition={{
...
//     <svg
//       viewBox="0 0 24 16"
//       className="flex-shrink-0 w-6 h-4 overflow-hidden rounded-sm"
//     >
