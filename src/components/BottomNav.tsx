...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full bg-white flex items-center justify-around px-1 pt-0.89 pb-[calc(0.125rem+env(safe-area-inset-bottom))] rounded-t-4xl shadow-[0_-2px_10px_rgba(0,0,0,0.08)] z-[90] md:px-12 lg:px-24">
        ...
        return (
          <NavLink
            ...
            className={`flex flex-col items-center gap-1 transition-colors ${
              isActive ? "text-[#8662B2]" : "text-gray-400"
            }`}
          >
