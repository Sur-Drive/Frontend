...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full bg-white flex items-center justify-around px-4 pt-3 pb-[calc(1rem+env(safe-area-inset-bottom))] rounded-t-2xl shadow-[0_-2px_10px_rgba(0,0,0,0.08)] z-50 md:px-12 lg:px-24">
      {navItems.map(({ to, icon: Icon, label, isCenter }) => {
