...
export default function HomePage() {
  ...
  // Distinguishes which flow the shared OTP screen belongs to, since both
  // sign-up and forgot-password reuse the same <OTP /> component.
  ...
  // ✅ WIRED TO SIGN IN AFTER SUCCESS
  const handleCreatePasswordComplete = (password: string) => {
    ...
    setShowSignIn(true)  // <-- Opens Sign In modal
  }
  ...
  return (
    <div className="relative h-[100dvh] w-full max-w-[430px] md:max-w-none mx-auto md:mx-0 bg-[#e4e4e4] overflow-hidden">
      ...
      {/* Forgot-password flow: new step 1 of 2 — set the new password */}
      <AnimatePresence>
      ...
      {/* Forgot-password flow: new step 2 of 2 — confirmation screen */}
      <AnimatePresence>
        {showResetSuccess && (
