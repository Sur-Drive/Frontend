        ...
        <p className="mt-2 text-[12px] leading-relaxed text-gray-500">
          {isConfirm ? (
            <>
              ...
              is still there. This helps other drivers stay safe.
            </>
          ) : (
            <>
              ...
              is no longer accurate. Thanks for keeping the map clean.
            </>
          )}
        </p>
  ...
  return (
    <div className="flex flex-col items-center px-6 pt-10 text-center sm:pt-14">
      ...
      <p className="max-w-sm mt-2 text-xs leading-relaxed text-gray-400 sm:text-sm">
        Confirm or mark hazards as incorrect to help other drivers stay safe.
...
export default function FeedPage() {
  ...
  const pendingHazard = pending
    ? hazards.find((h) => h.id === pending.hazardId)
    : undefined;
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-28">
      <div className="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        {locationError && (
          <div className="flex items-start max-w-md gap-2 px-3 py-2 mx-auto mb-3 border border-yellow-200 rounded-xl bg-yellow-50">
            <span className="mt-0.5 text-sm text-yellow-600">⚠️</span>
            <div className="flex-1">
              <p className="text-[12px] font-medium text-yellow-800">
                Couldn't get your exact location: {locationError}
              </p>
              <p className="mt-0.5 text-[11px] text-yellow-600">
                Showing reports for the default area instead.
              </p>
            </div>
          </div>
        )}
        ...
        {isLoading ? (
          ...
          <p className="text-[13px] text-center text-gray-400 max-w-md mx-auto">
