...
//         <button
//           key={r.id}
//           className="absolute z-[5] flex flex-col items-center cursor-pointer transition-transform active:scale-95"
//           style={{
//             top: r.top,
//             left: r.left,
...
//           onTouchStart={startSOSHold}
//           onTouchEnd={endSOSHold}
//           className="absolute z-30 flex flex-col items-center justify-center w-20 h-20 text-white transition rounded-full select-none bottom-32 right-4 bg-[#ff4444] active:scale-95 touch-none"
//           style={{
//             background: sosHolding
//               ? `conic-gradient(white ${sosProgress}%, rgba(239,68,68,0.9) ${sosProgress}%)`
//               : undefined,
...
//         setShowSOS(true)
//       }
//     }, 60) // ~3 seconds total (100 * 60ms = 6000ms, but feels right with 2% increments)
//   }, [showSOS])
...
//       {/* Plan Route Modal */}
//       {showPlanModal && (
//         <div className="absolute inset-0 z-40 flex flex-col bg-white animate-in slide-in-from-bottom">
//           {/* Header */}
...
//           {/* Scrollable content */}
//           <div className="flex-1 px-5 space-y-5 overflow-y-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
//             {/* Point A */}
//             <div>
//               <div className="flex items-center gap-2 mb-2">
//                 <div className="flex items-center justify-center w-5 h-5 border-2 rounded-full border-emerald-500">
...
//       {/* SOS Active Screen */}
//       {showSOS && (
//         <div className="absolute inset-0 z-50 flex flex-col overflow-y-auto bg-red-500">
//           {/* Header */}
//           <div className="flex items-start justify-between px-5 pt-14">
//             <div>
//               <h2 className="text-3xl font-extrabold text-white">SOS Active</h2>
