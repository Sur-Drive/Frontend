        ...
        <div className="px-4 sm:px-5">
          ...
          <div className="relative p-4 overflow-hidden sm:p-5 rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="flex items-center justify-center text-base font-bold text-white bg-purple-700 rounded-full w-14 h-14 sm:w-16 sm:h-16 sm:text-lg shrink-0">
                {user.initials}
              </div>
              <div className="min-w-0">
                <p className="text-base font-extrabold text-gray-900 truncate sm:text-xl">
                  {user.name}
                </p>
                <p className="text-[13px] sm:text-[15px] text-gray-400 truncate">
                  {user.email}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-3 mt-4 sm:mt-5">
              <div className="p-3 sm:p-4 rounded-2xl bg-gray-100/80">
                ...
                <p className="text-[13px] sm:text-[14px] text-gray-400">{user.drivingGrade}</p>
              </div>
              <div className="p-3 sm:p-4 rounded-2xl bg-gray-100/80">
          ...
          {/* Sign out */}
          <button className="mt-6 sm:mt-8 flex w-full items-center justify-center gap-2 rounded-2xl bg-red-400 py-3.5 sm:py-4 text-[15px] sm:text-[16px] font-semibold text-white transition active:scale-[0.98]">
            <LogOut size={16} className="sm:w-[18px] sm:h-[18px]" /> Sign out
          </button>
        </div>
      </div>
