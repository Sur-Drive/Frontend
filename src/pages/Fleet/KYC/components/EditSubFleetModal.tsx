...
import { updateSubFleet } from "../../../../api/subFleet";

interface EditSubFleetModalProps {
    subFleet: any;
    onClose: () => void;
    onSuccess: () => void;
}

const EditSubFleetModal: React.FC<EditSubFleetModalProps> = ({
    subFleet,
    onClose,
    onSuccess,
}) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError(null);
        try {
            await updateSubFleet(subFleet.id, formData);
            onSuccess();
            onClose();
        } catch (err: any) {
...
export default EditSubFleetModal;
