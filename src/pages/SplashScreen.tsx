...
export default function SplashScreen() {
  return (
    <div className="flex flex-col h-[100dvh] w-full bg-[#6E43A3]">
      ...
      {/* Content capped to a phone-width column and centered — keeps this
          reading as an app splash instead of a huge wordmark stretched
          across a wide desktop PWA window. */}
      <div className="flex items-center justify-center flex-1 px-6">
        <div className="flex items-center gap-2 w-full max-w-[280px] justify-center animate-[fadeInUp_0.6s_ease-out]">
          <img
            src={logo}
            alt="SUR-DRIVE logo"
            className="object-contain w-10 h-10 sm:w-12 sm:h-12 shrink-0"
          />

          <div>
            <h1 className="text-lg font-extrabold leading-none tracking-tight text-white sm:text-xl">
              SUR-DRIVE
              <sup className="text-[7px] sm:text-[8px] text-yellow-400 align-super ml-0.5">HT</sup>
            </h1>
            <p className="text-yellow-400 text-[8px] sm:text-[9px] font-bold tracking-widest mt-1">
              YOUR ROAD. YOUR GUIDE.
            </p>
          </div>
        </div>
