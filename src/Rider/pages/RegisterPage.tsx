...
export default function RegisterPage() {
  ...
  const submit = () => {
    ...
    // No API for now: simulate sending the OTP and move on.
    ...
    <div className="font-outfit min-h-[100dvh] bg-white px-6 pb-8 pt-4">
        ...
        <div className="relative" ref={cityRef}>
          ...
          >
            <span className="flex items-center gap-3">
              ...
              <span
                className={city ? "text-base text-gray-800" : "text-base text-gray-400"}
              >
                {city || "Select city"}
              </span>
            </span>
      ...
      <label className="mt-5 flex cursor-pointer items-start gap-3">
        ...
        <p className="text-sm leading-relaxed text-gray-400">
          ...
          our services - you can unsubscribe anytime in notification setting
          {" "}under your profile
        </p>
      </label>
